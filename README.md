...
Punch holes in the update-pages and put them face up on a pile right of your songbook (the update pile).
...
***Note:** The algorithm requires you to compare pages. This done by comparing the sort order (songtitle/artist). Of course there could be minor differences in the page's contents, it's an update after all. But if the sort order is the same, the pages are considered to be the same.*

***Note:** If you have to empty pages to compare, look at their backsides.*
